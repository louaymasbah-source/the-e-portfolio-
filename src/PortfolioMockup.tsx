      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/70 border-b shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-600 text-white grid place-items-center font-bold shadow-sm">
              L
            </div>
      ...
      <section id="welcome" className="relative max-w-6xl mx-auto px-4 pt-12 pb-14">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-2 space-y-4">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-indigo-700 to-violet-600 bg-clip-text text-transparent">
              Digital Sciences student at ENSEEIHT Toulouse
            </h1>
      ...
      <section id="career" className="bg-white border-y py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            ...
            {/* Elevator Pitch embed */}
            <div className="md:col-span-2 rounded-2xl border bg-white overflow-hidden">
              <div className="text-sm uppercase tracking-wider text-slate-500 px-4 pt-3">Elevator Pitch</div>
              <div className="aspect-video rounded-xl overflow-hidden border mx-3 mb-3">
                <iframe
                  src={LINKS.pitchVideoEmbed}
              ...
              <div className="px-4 pb-3">
                <a
                  href={LINKS.pitchVideoWatch}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block mt-1 px-4 py-2 rounded-xl bg-slate-900 text-white"
                >
                  Open on YouTube
                </a>
              </div>
          ...
          <div className="mb-4 flex gap-2" role="tablist" aria-label="International Mobility tabs">
            <button
              onClick={() => setMobTab("LV2")}
              aria-selected={mobTab === "LV2"}
              role="tab"
              className={`px-3 py-1 rounded-lg border transition ${
                mobTab === "LV2" ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow" : "bg-white hover:bg-slate-50"
              }`}
            >
              LV2
            </button>
            <button
              onClick={() => setMobTab("PCE")}
              aria-selected={mobTab === "PCE"}
              role="tab"
              className={`px-3 py-1 rounded-lg border transition ${
                mobTab === "PCE" ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow" : "bg-white hover:bg-slate-50"
              }`}
            >
              PCE
            </button>
            <button
              onClick={() => setMobTab("EXP")}
              aria-selected={mobTab === "EXP"}
              role="tab"
              className={`px-3 py-1 rounded-lg border transition ${
                mobTab === "EXP" ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow" : "bg-white hover:bg-slate-50"
              }`}
            >
      ...
      <section id="engineering" className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-6 flex gap-2" role="tablist" aria-label="Engineering tabs">
          <button
            ...
            className={`px-3 py-1 rounded-lg border transition ${
              engTab === "projects" ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow" : "bg-white hover:bg-slate-50"
            }`}
          >
            Projects
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-lg border transition ${
              engTab === "productions" ? "bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow" : "bg-white hover:bg-slate-50"
            }`}
          >
            Productions
          </button>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-2xl border bg-white/90 p-5 shadow-sm hover:shadow-md transition-transform duration-200 hover:-translate-y-0.5">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <a
                    data-test="tipe-slides"
                    href={LINKS.tipeSlides}
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <a
                    data-test="tipe-notes"
                    href={LINKS.tipeNotes}
                    target="_blank"
                    rel="noreferrer"
                    className="text-xs px-3 py-1 rounded-lg border"
                  >
